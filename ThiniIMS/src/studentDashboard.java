...
public class studentDashboard extends JFrame {
	...
	public studentDashboard() {
		...
		JLabel studentIdLabel = new JLabel(loggedInStudentId.isEmpty() ? "Student" : loggedInStudentId);
		...
		Object[][] data = { { "Mouse", "001", "Input Device", "Available" },
				{ "Keyboard", "002", "Input Device", "In Use" }, { "Webcam", "003", "Video", "Available" },
				{ "Headset", "004", "Audio", "Available" }, { "Monitor", "005", "Display", "In Use" } };
		...
		Object[][] borrowedData = { { "Mouse", "001", "2025-04-30", "2025-05-07" },
		...
		searchBorrowedItems.addActionListener(e -> {
			...
			if (studentId.equals("Student ID") || studentId.isEmpty()) {
				JOptionPane.showMessageDialog(this, "Please enter a Student ID", "Input Required",
			...
			JOptionPane.showMessageDialog(this, "Found borrowed items for Student ID: " + studentId, "Success",
		...
		returnEquipmentButton.addActionListener(e -> {
			if (selectedItemLabel.getText().equals("None selected")) {
				JOptionPane.showMessageDialog(this, "Please select an item to return from the borrowed items table",
			...
			if (confirm == JOptionPane.YES_OPTION) {
				...
				returnHistoryModel.addRow(new Object[] { itemName, itemId, returnDate, condition });
				...
				availableItemsModel
						.addRow(new Object[] { itemName, itemId, getCategoryForItem(itemName), "Available" });
				...
				JOptionPane.showMessageDialog(this, "Equipment returned successfully!", "Return Complete",
						JOptionPane.INFORMATION_MESSAGE);
			}
		});
